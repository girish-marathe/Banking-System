<%-- 
    ...
    Created on : Dec 28, 2017, 9:55:46 PM
    Author     : PTPL-02
--%>
...
<html>
    <head>
        <title>Add Branch Employee</title>
        ...
        <div id="wrapper">
            ...
            <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp">Bank</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="addEmployee.jsp"><i class="fa fa-user nav_icon"></i>Add Employee</a>
                            </li>
                            <li>
                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="panel-body">
                                <form role="form" name="form1" class="form-horizontal" action="AddEmployee" method="post" enctype="multipart/form-data" onsubmit="return myValidation()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="Email Address"  name="email" id="email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="Designation" name="designation" id="designation">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
