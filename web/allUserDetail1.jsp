<%-- 
    Document   : allUserDetail1
    Created on : Dec 28, 2017, 11:58:48 PM
    Author     : PTPL-02
--%>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="deleteUser1.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa  fa-trash-o" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%}
                                    %>
                                </tbody>
