<%-- 
    ...
    Created on : Dec 26, 2017, 11:43:43 PM
    Author     : PTPL-02
--%>
...
<html>
    <head>
        ...
        <%
            ...
            String imgpath = "";
            String sql = "Select * from tbl_manager where uname='" + uname + "'";
        ...
        <div id="wrapper">
            ...
            <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="<%=imgpath%>"><span class="badge"></span></a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="managerHome.jsp"><i class="fa fa-dashboard fa-fw nav_icon"></i>Dashboard</a>
                            </li>
                            <li>
