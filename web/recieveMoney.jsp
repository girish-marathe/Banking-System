<%-- 
    Document   : recieveMoney
    Created on : Dec 28, 2017, 3:30:09 AM
    Author     : PTPL-02
--%>
...
//                                String email = httpSession.getAttribute("email").toString();
                                ...
                                String sql = "Select * from tbl_transaction where remail='" + email + "' OR semail='" + email + "'";
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <%while (rs.next()) {
                                                    ...
                                                    String status = "Debit";
                                                    String user=email;
                                                    if (rs.getString("remail").equals(email)) {
                                                        status = "Credit";
                                                        user=rs.getString("semail");
                                                    }else
                                                    {
                                                         user=rs.getString("remail");
                                                    }
                                            %>
                                            <tr>
                                                <td><%=user%></td>
