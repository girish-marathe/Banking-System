<%-- 
    Document   : editUser
    Created on : Dec 26, 2017, 2:01:53 AM
    Author     : PTPL-02
--%>
                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="panel-body">
                                ...
                                <form role="form" name="form1" class="form-horizontal" action="CreateAccount1" method="post" enctype="multipart/form-data" onsubmit="return myValidation()">
                                    <%
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="First Name" value="<%=rs.getString("Branch_name")%>" name="branch" id="branch">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="Last Name" value="<%=rs.getString("lname")%>" name="lname" id="lname">
                                            </div>
                                        </div>
                                    </div>     
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="email" class="form-control1" placeholder="Email Address" value="<%=rs.getString("email")%>" name="email" id="email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control1" placeholder="Mobile" value="<%=rs.getString("mobile")%>" name="mobile"  id="mobile">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="Adhar number" value="<%=rs.getString("adhar_id")%>" name="adhar_id" id="adhar_id">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">							
                                                ...
                                                <input type="text" class="form-control1" placeholder="PAN Number" value="<%=rs.getString("pan_id")%>" name="pan_id" id="pan_id">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control1" id="bdate" placeholder="Date of Birth" value="<%=rs.getString("dob")%>" name="bdate">
                                            </div>
                                        </div>
                                    </div>
