<%-- 
    ...
    Created on : Dec 28, 2017, 10:16:16 PM
    Author     : PTPL-02
--%>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="showEmployee.jsp"><i class="fa fa-users nav_icon"></i>Show Employee</a>
                            </li>
                            <li>
                                <a href="transaction.jsp"><i class="fa fa-exchange nav_icon"></i>Transaction<span class="fa arrow"></span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
            ...
            <div class="xs">
                <%
                    try {
                        ...
                        String sql = "Select * from tbl_manager where branch='" + branch + "'and desiganation='employee'";
                        rs = db.Select(sql);
                %>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=rs.getString("desiganation")%></td>
                                        <td><%=rs.getString("status")%></td>
                                        <td><%=rs.getString("gender")%></td>
                                        <td><i class="fa fa-eye" aria-hidden="true" id="<%=rs.getString("email")%>" name="view_data"></i></td>
                                        <td><a href="activateEmployee.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('If you want activate/Deactivate User?');"><i class="fa  fa-pencil-square" aria-hidden="true"></i></a></td>
                                        <td><a href="deleteUser.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa  fa-trash-o" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%}
                                    %>
                                </tbody>
