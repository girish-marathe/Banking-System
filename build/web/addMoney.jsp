<%-- 
    Document   : addMoney
    Created on : Dec 26, 2017, 3:12:23 AM
    Author     : PTPL-02
--%>
    ...
    <head>
        ...
        <script>
            function myValidation() {
                ...
                if (fname == 0 || email == 0 || ifsc == 0 || accno == 0 || amount == 0) {
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="addMoney.jsp"><i class="fa fa-building-o nav_icon"></i>Add Money</a>
                            </li>
            ...
            <div class="xs">
                ...
                <div class="tab-content">
                    <div class="panel-body">
                        <form role="form" name="form1" class="form-horizontal" action="AddMoney" method="post" onsubmit="return myValidation()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">							
                                        ...
                                        <input type="text" class="form-control1" placeholder="Amount" name="amount" id="amount">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <div class="submit"><input type="submit"  value="Add Money"></div>
                                    </div>
                                </div>
                            </div>
