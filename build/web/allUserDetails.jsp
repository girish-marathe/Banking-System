<%-- 
    Document   : allUserDetails
    Created on : Dec 5, 2017, 3:59:25 AM
    Author     : PTPL-02
--%>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="allUserDetails.jsp"><i class="fa fa-building-o nav_icon"></i>Activation</a>
            ...
            <div class="xs">
                <%
                    try {
                        ...
                        String sql = "Select * from tbl_user_account where branch_name='" + branch + "'";
                        rs = db.Select(sql);
                %>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="activateUser.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('If you want activate/Deactivate User?');"><i class="fa  fa-pencil-square" aria-hidden="true"></i></a></td>
