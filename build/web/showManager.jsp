<%-- 
    ...
    Created on : Dec 25, 2017, 10:14:23 PM
    Author     : PTPL-02
--%>
                    ...
                    <div class="xs">
                        ...
                        <%
                            try {
                                ...
                                String sql = "Select * from tbl_manager where desiganation='manager'";
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="deleteManager.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('Are you sure you want to delete ?');"><i class="fa  fa-trash-o" aria-hidden="true"></i></a></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
                                    </table>
