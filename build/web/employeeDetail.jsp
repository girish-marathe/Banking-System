<%-- 
    ...
    Created on : Dec 28, 2017, 11:51:12 PM
    Author     : PTPL-02
--%>
                    ...
                    <div class="xs">
                        ...
                        <%
                            try {
                                ...
                                String sql = "Select * from tbl_manager where desiganation='employee'";
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="activateManager.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('If you want change status for manager ?');"><i class="fa  fa-pencil-square" aria-hidden="true"></i></a></td>
                                                <td><a href="deleteManager1.jsp?email=<%=rs.getString("email")%>" onclick="return confirm('Are you sure you want to delete ?');"><i class="fa  fa-trash-o" aria-hidden="true"></i></a></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
                                    </table>
