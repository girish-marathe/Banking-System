...
public class AddManager extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String uname = "", desiganition = "manager";
...
//                    allsignatures.add(signature.trim());
            ...
            if (rs.next()) {
                ...
                out.println("alert('Manager has already exists!');");
                ...
                if (result > 0) {
                    httpSession.setAttribute("uname", uname);
                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('Adding new branch manager successfully!');");
                    out.println("location='adminHome.jsp';");
                    out.println("</script>");
                    return;
                } else {
                    httpSession.setAttribute("uname", uname);
                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('Branch Manager has not added!');");
