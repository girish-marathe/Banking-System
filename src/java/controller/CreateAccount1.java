...
//                    allsignatures.add(signature.trim());
                ...
                String sql1 = "Update tbl_user_account set fname='"+tname+"',lname='"+lname+"',address='"+address+"',email='"+email+"',gender='"+gender+"',mobile='"+mobile+"',adhar_id='"+adhar_id+"',pan_id='"+pan_id+"',image='',imgpath='"+imgPath+"',dob='"+dob+"' where uname='"+uname+"'";
